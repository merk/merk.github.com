import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-DuJsiTVZ.js";import{S as n,nt as r,o as i,t as a}from"./lucide-react-63PKmNkv.js";import{n as o,t as s}from"./IconButton-DgqCRk3a.js";import{n as c,t as l}from"./ToggleButton-D0rNkvXH.js";import{n as u,t as d}from"./story-helpers-BFObhnYI.js";var f,p,m,h,g,_,v;e((()=>{a(),o(),u(),c(),f=t(),p={title:`Kit/IconButton`,component:s},m=[`active`,`enabled`,`quiet`],h={render:()=>(0,f.jsx)(`table`,{style:{borderSpacing:`var(--space-3)`},children:(0,f.jsx)(`tbody`,{children:m.map(e=>(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{style:{color:`var(--ink2)`,font:`400 var(--text-micro) var(--font-mono)`},children:e}),(0,f.jsx)(`td`,{children:(0,f.jsx)(s,{label:`Undo`,icon:i,weight:e})}),(0,f.jsx)(`td`,{children:(0,f.jsx)(d,{attr:`data-hovered`,children:(0,f.jsx)(s,{label:`Undo`,icon:i,weight:e})})}),(0,f.jsx)(`td`,{children:(0,f.jsx)(d,{attr:`data-pressed`,children:(0,f.jsx)(s,{label:`Undo`,icon:i,weight:e})})}),(0,f.jsx)(`td`,{children:(0,f.jsx)(d,{attr:`data-focus-visible`,children:(0,f.jsx)(s,{label:`Undo`,icon:i,weight:e})})}),(0,f.jsx)(`td`,{children:(0,f.jsx)(s,{label:`Undo`,icon:i,weight:e,isDisabled:!0})})]},e))})})},g={render:()=>(0,f.jsxs)(`div`,{style:{display:`flex`,gap:`var(--space-3)`,alignItems:`center`},children:[(0,f.jsx)(s,{label:`Save`,icon:n,size:`sm`}),(0,f.jsx)(s,{label:`Save`,icon:n,size:`md`})]})},_={render:()=>(0,f.jsxs)(`div`,{style:{display:`grid`,gap:`var(--space-3)`},children:[(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`div`,{style:{color:`var(--ink2)`,font:`400 var(--text-micro) var(--font-mono)`},children:`IconButton — actions (save, undo)`}),(0,f.jsxs)(`div`,{style:{display:`flex`,gap:`var(--space-2)`},children:[(0,f.jsx)(s,{label:`Save`,icon:n,weight:`enabled`}),(0,f.jsx)(s,{label:`Undo`,icon:i,weight:`enabled`}),(0,f.jsx)(s,{label:`Undo`,icon:i,weight:`quiet`})]})]}),(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`div`,{style:{color:`var(--ink2)`,font:`400 var(--text-micro) var(--font-mono)`},children:`ToggleButton — state (diagnostics on/off)`}),(0,f.jsxs)(`div`,{style:{display:`flex`,gap:`var(--space-2)`},children:[(0,f.jsx)(l,{isSelected:!1,label:`Diagnostics`,icon:r}),(0,f.jsx)(l,{isSelected:!0,label:`Diagnostics`,icon:r})]})]})]})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: () => <table style={{
