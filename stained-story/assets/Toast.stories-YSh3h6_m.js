import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{n,t as r}from"./iframe-sr_6Wtjm.js";import{n as i,t as a}from"./Button-CZ17wyqP.js";import{n as o,t as s}from"./story-helpers-CnQDC2k8.js";import{n as c,r as l,t as u}from"./Toast-Dmj1QWPZ.js";var d,f,p,m,h,g,_,v;e((()=>{d=t(n(),1),i(),o(),l(),f=r(),p={title:`Kit/Toast`,component:u},m={render:()=>(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`var(--space-2)`,width:`320px`},children:[(0,f.jsx)(u,{item:{id:1,level:`info`,message:`Autosaved`},onDismiss:()=>{}}),(0,f.jsx)(u,{item:{id:2,level:`warning`,message:`Reference not calibrated`},onDismiss:()=>{}}),(0,f.jsx)(u,{item:{id:3,level:`error`,message:`Save failed`,detail:`disk full`},onDismiss:()=>{}})]})},h={render:()=>(0,f.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`var(--space-2)`,width:`320px`},children:[(0,f.jsx)(u,{item:{id:1,level:`error`,message:`Save failed`},onDismiss:()=>{}}),(0,f.jsx)(u,{item:{id:2,level:`error`,message:`Save failed`,detail:`disk full`},onDismiss:()=>{}})]})},g={render:()=>(0,f.jsx)(`div`,{style:{display:`flex`,gap:`var(--space-3)`},children:[[`resting`,void 0],[`hovered`,`data-hovered`],[`pressed`,`data-pressed`],[`focused`,`data-focus-visible`]].map(([e,t])=>{let n=(0,f.jsx)(u,{item:{id:1,level:`info`,message:`Autosaved`},onDismiss:()=>{}});return(0,f.jsxs)(`div`,{style:{display:`grid`,gap:`var(--space-1)`,width:`220px`},children:[(0,f.jsx)(`span`,{style:{color:`var(--ink2)`,font:`400 var(--text-micro) var(--font-mono)`},children:e}),t===void 0?n:(0,f.jsx)(s,{attr:t,selector:`button`,children:n})]},e)})})},_={render:function(){let[e,t]=(0,d.useState)([{id:1,level:`info`,message:`Autosaved`}]),n=2,r=e=>{let r=n++,i=e===`error`?`Save failed`:e===`warning`?`Reference not calibrated`:`Autosaved`;t(t=>[...t,{id:r,level:e,message:i}])};return(0,f.jsxs)(`div`,{style:{display:`flex`,gap:`var(--space-2)`},children:[(0,f.jsx)(a,{size:`sm`,onPress:()=>r(`info`),children:`Push info`}),(0,f.jsx)(a,{size:`sm`,onPress:()=>r(`warning`),children:`Push warning`}),(0,f.jsx)(a,{size:`sm`,onPress:()=>r(`error`),children:`Push error`}),(0,f.jsx)(c,{items:e,onDismiss:e=>t(t=>t.filter(t=>t.id!==e))})]})}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
