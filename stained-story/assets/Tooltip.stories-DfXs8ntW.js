import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-BDLP3HaD.js";import{st as n,t as r}from"./exports-CaGG7_wL.js";import{t as i,w as a}from"./lucide-react-BWkCotZC.js";import{n as o,t as s}from"./Tooltip-D524nXqn.js";import{n as c,t as l}from"./IconButton-C_pWBQ61.js";var u,d,f,p,m,h,g;e((()=>{i(),r(),c(),o(),u=t(),d={title:`Kit/Tooltip`,component:s},f={render:()=>(0,u.jsx)(`div`,{style:{width:`160px`},children:(0,u.jsx)(s,{content:`Voronoi relaxation (Lloyd, 8 iterations) over Poisson seed`,defaultOpen:!0,children:(0,u.jsx)(n,{style:{display:`block`,width:`100%`,overflow:`hidden`,whiteSpace:`nowrap`,textOverflow:`ellipsis`,textAlign:`left`,font:`var(--weight-regular) var(--text-ui)/var(--lh-tight) var(--font-sans)`,color:`var(--ink)`,background:`none`,border:`none`,padding:0,cursor:`default`},children:`Voronoi relaxation (Lloyd, 8 iterations) over Poisson seed`})})})},p={render:()=>(0,u.jsx)(s,{content:`Save`,defaultOpen:!0,children:(0,u.jsx)(l,{label:`Save`,icon:a})})},m={render:()=>(0,u.jsx)(s,{content:`This tool traces a lead line along the pointer path. Snap targets are edges, vertices, and the sheet's own boundary — hold Shift to disable snapping.`,defaultOpen:!0,children:(0,u.jsx)(n,{children:`Pen tool`})})},h={render:()=>(0,u.jsxs)(`div`,{style:{display:`grid`,gap:`var(--space-3)`},children:[(0,u.jsx)(`div`,{style:{color:`var(--ink2)`,font:`400 var(--text-micro) var(--font-mono)`},children:`tab into the button below — no hover involved`}),(0,u.jsx)(s,{content:`Undo the last cut`,children:(0,u.jsx)(n,{children:`Undo`})})]})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    width: '160px'
  }}>
