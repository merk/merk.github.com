import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-sr_6Wtjm.js";import{n,t as r}from"./story-helpers-CnQDC2k8.js";import{n as i,t as a}from"./Callout-CRvFvNpg.js";var o,s,c,l,u,d,f,p;e((()=>{i(),n(),o=t(),s={title:`Kit/Callout`,component:a},c=[`error`,`warn`,`info`],l={render:()=>(0,o.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`var(--space-3)`},children:c.map(e=>(0,o.jsx)(a,{severity:e,message:`A ${e} advisory message.`},e))})},u={render:()=>(0,o.jsx)(`div`,{style:{position:`relative`,width:`420px`,height:`260px`,background:`var(--canvas)`,border:`1px solid var(--line)`,borderRadius:`var(--radius-2)`},children:(0,o.jsx)(`div`,{style:{position:`absolute`,right:`var(--space-3)`,top:`var(--space-3)`},children:(0,o.jsx)(a,{severity:`warn`,message:`Reference not calibrated.`,action:{label:`Calibrate`,onPress:()=>{}}})})})},d={render:()=>(0,o.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`var(--space-3)`},children:[(0,o.jsx)(a,{severity:`warn`,message:`Cut angle is tight for this glass.`}),(0,o.jsx)(a,{severity:`warn`,message:`Cut angle is tight for this glass.`,action:{label:`Show diagnostic`,onPress:()=>{}}})]})},f={render:()=>(0,o.jsx)(`div`,{style:{display:`flex`,gap:`var(--space-3)`},children:[[`resting`,void 0],[`hovered`,`data-hovered`],[`pressed`,`data-pressed`],[`focused`,`data-focus-visible`]].map(([e,t])=>{let n=(0,o.jsx)(a,{severity:`warn`,message:`Reference not calibrated.`,action:{label:`Calibrate`,onPress:()=>{}}});return(0,o.jsxs)(`div`,{style:{display:`grid`,gap:`var(--space-1)`},children:[(0,o.jsx)(`span`,{style:{color:`var(--ink2)`,font:`400 var(--text-micro) var(--font-mono)`},children:e}),t===void 0?n:(0,o.jsx)(r,{attr:t,children:n})]},e)})})},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
