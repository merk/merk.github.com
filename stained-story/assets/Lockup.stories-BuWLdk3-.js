import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./iframe-BRbLK8OP.js";import{n,t as r}from"./Lockup-B38pmaK5.js";var i,a,o,s,c,l,u;e((()=>{n(),i=t(),a={title:`Kit/Lockup`,component:r},o={args:{size:`default`}},s={args:{size:`default`},render:()=>(0,i.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`var(--space-4)`},children:[`default`,`compact`].map(e=>(0,i.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`var(--space-3)`},children:[(0,i.jsx)(r,{size:e}),(0,i.jsx)(`span`,{style:{font:`var(--weight-regular) var(--text-micro)/var(--lh-tight) var(--font-mono)`,color:`var(--ink2)`},children:e})]},e))})},c={args:{size:`default`},render:e=>(0,i.jsx)(`div`,{style:{background:`var(--bar-bg)`,padding:`var(--space-3) var(--space-4)`,borderRadius:`var(--radius-1)`},children:(0,i.jsx)(r,{...e})})},l={args:{size:`compact`},render:e=>(0,i.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,height:`44px`,background:`var(--bar-bg)`,borderBottom:`1px solid var(--line)`,padding:`0 var(--space-4)`},children:(0,i.jsx)(r,{...e})})},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'default'
  }
